...
//==================================== CAC MENU CHUC NANG ========================================================
    static void menuSuaThongTin() {
        ...
        System.out.println("\t\t _Lua chon cua ban : ");
    }
    ...
    static void xuatFileSinhVien() throws FileNotFoundException, CsvDataTypeMismatchException, CsvRequiredFieldEmptyException {
        ...
        switch (chon) {
            case 1:
                ...
                ReadAndWriteCSV readAT = new ReadAndWriteCSV();
                readAT.WriteFileCSV_ATTT(khoa_ATTT);
                break;
            case 2:
                ReadAndWriteCSV readCT = new ReadAndWriteCSV();
                readCT.WriteFileCSV_CNTT(khoa_CNTT);
                break;
            case 3:
                ReadAndWriteCSV readDT = new ReadAndWriteCSV();
                readDT.WriteFileCSV_DTVT(khoa_DTVT);
                break;
